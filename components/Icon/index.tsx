...
export type IconType = "error" | "star"
...
export default function( props: IconProps ) {
    return (
        <svg className={style.svg} clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d={Paths[props.type]} fill-rule="nonzero"/></svg>
    )
}